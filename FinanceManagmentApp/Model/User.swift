...
class User: ObservableObject {
    ...
    @Published var personalAccount  =  PersonalAccount(cardInfo: CardInfo(cardNumber: "1111 2222 3333 4444", cvv: "333", expDate: "12/10"), cardSetting: CardSetting(cardLimit: 3000, isCardLocked: false, isEcommerceTransDisabled: false), totalBalance: 3000, thisMonthBudget: 3000, thisMonthExpense: 2000)
